...
const storyTree: Record<string, StoryNode> = {
  ...
  trapped: {
    lines: [
      "YOUR SEMANTIC LAYER SHOULD BE YOUR SOURCE OF TRUTH.",
      "BUT NOBODY TRUSTS THE DASHBOARDS.",
      "SO YOU WRITE ANOTHER NOTEBOOK. ANOTHER QUERY.",
      "GOVERNANCE? FRAGMENTED. DEFINITIONS? INCONSISTENT.",
    ],
  ...
  deeper: {
    lines: [
      ...
      "SELF-SERVE? MORE LIKE SELF-STRUGGLE.",
      "YOUR DATA TEAM BECOMES A BOTTLENECK.",
      "NOT BECAUSE THEY'RE SLOW. BECAUSE THE TOOL IS.",
    ],
  ...
  comfortable: {
    lines: [
      "STAY IF YOU WANT.",
      "UNGOVERNED METRICS. BROKEN LINEAGE.",
  ...
  hesitate: {
    lines: [
      "EVERY WEEK:",
      "REBUILD DEFINITIONS. RE-EXPLAIN METRICS.",
      "FIELD QUESTIONS YOUR TOOL SHOULD ANSWER ITSELF.",
      "WHAT IF IT COULD?",
    ],
  ...
  redpill: {
    lines: [
      ...
      "",
      "THIS IS OMNI.",
      "ONE GOVERNED SEMANTIC LAYER. ONE SOURCE OF TRUTH.",
      "SELF-SERVE THAT ACTUALLY WORKS.",
      "ASK A QUESTION. GET THE ANSWER.",
      "",
      "NO NOTEBOOKS. NO BOTTLENECKS. NO GUESSWORK.",
    ],
